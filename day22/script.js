...
//         console.log('🔊 Streaming audio initialized');
//     }
// }

// // Play audio chunk immediately (seamless streaming)
...
//     console.log('Sending text request to:', `${SERVER_BASE_URL}/agent/chat/${currentSessionId}`);
                    ...
                    if (line.startsWith('data: ')) {
                        try {
                            ...
                            if (data.type === 'audio_chunk') {
                                ...
                                await playAudioChunk(data.audio_data);
                            }
...
// Enhanced Transcription and Processing with Streaming Support
async function transcribeAndProcess(audioBlob, voiceId = 'en-US-natalie') {
  console.log('Starting transcription and processing...');
...
console.log('Streaming audio integration loaded!');
console.log('Enhanced Voice Chat Client JavaScript loaded successfully!');
