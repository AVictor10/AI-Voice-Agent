...
#     """
#     Query LLM (Gemini) with input text and return the response
#     """
#     try:
#         if not gemini_model:
...
#         print(f"Querying Gemini with text: {request.text}")
        
#         # Generate response using Gemini
#         response = gemini_model.generate_content(request.text)
...
#         "gemini_model": "gemini-pro" if gemini_model else None
#     }
